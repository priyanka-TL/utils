module.exports = {
	routes: [
		...
		{
			sourceRoute: '/mentoring/v1/questions-set/create',
			type: 'POST',
			priority: 'MUST_HAVE',
			inSequence: false,
			orchestrated: false,
			targetRoute: {
				path: '/mentoring/v1/questions-set/create',
				type: 'POST',
			},
		},
		{
			sourceRoute: '/mentoring/v1/questions-set/update',
			type: 'PATCH',
			inSequence: false,
			orchestrated: false,
			targetRoute: {
				path: '/mentoring/v1/questions-set/update',
				type: 'PATCH',
			},
		},
		{
			sourceRoute: '/mentoring/v1/questions-set/update/:id',
			type: 'PATCH',
			inSequence: false,
			orchestrated: false,
			targetRoute: {
				path: '/mentoring/v1/questions-set/update/:id',
				type: 'PATCH',
			},
		},
		{
			sourceRoute: '/mentoring/v1/questions-set/read',
			type: 'POST',
			inSequence: false,
			orchestrated: false,
			targetRoute: {
				path: '/mentoring/v1/questions-set/read',
				type: 'POST',
			},
		},
		{
			sourceRoute: '/mentoring/v1/questions-set/read/:id',
			type: 'POST',
			inSequence: false,
			orchestrated: false,
			targetRoute: {
				path: '/mentoring/v1/questions-set/read/:id',
				type: 'POST',
			},
		},
		{
